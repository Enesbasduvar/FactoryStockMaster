                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped mb-0">
                                            ...
                                            $sql = "SELECT urun_adi, urun_barkod, urun_kodu, miktar, musteri_adi, tarih, iskonto_orani, nakit_orani, bartir_orani FROM satis_faturalari";
                                            $result = $baglan->query($sql);

                                            if ($result->num_rows > 0) {
                                                
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr><td>" . $row["urun_adi"] . "</td>
                                                    <td>" . $row["urun_barkod"] . "</td>
                                                    <td>" . $row["urun_kodu"] . "</td>
                                                    <td>" . $row["miktar"] . "</td>
                                                    <td>" . $row["musteri_adi"] . "</td>
                                                    <td>" . $row["tarih"] . "</td>
                                                    <td>" . $row["iskonto_orani"] . "</td>
                                                    <td>" . $row["nakit_orani"] . "</td>
                                                    <td>" . $row["bartir_orani"] . "</td>
                                                    </tr>";
                                                }
                                                echo "</tbody></table>";
                                            } else {
