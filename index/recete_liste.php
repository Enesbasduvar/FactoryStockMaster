                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Reçeteler</h4>

                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a href="javascript: void(0);">Pages</a></li>
                                        <li class="breadcrumb-item active">Reçeteler</li>
                                    </ol>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="datatable-buttons" class="table table-striped dt-responsive nowrap">
                                        ...
                                        <?php
                                            ...
                                            // Reçeteleri sorgula
                                            $sqlReceteler = "SELECT * FROM receteler";
                                            $resultReceteler = $baglan->query($sqlReceteler);

                                            if ($resultReceteler->num_rows > 0) {
                                      
                                                
                                             while ($row = $resultReceteler->fetch_assoc()) {
                                                    $receteID = $row['Recete_id'];
                                                    $receteNo = $row['Recete_no'];
                                                    $tarih = $row['Tarih'];
                                                    ...
                                                    echo "<tr>
                                                            ...
                                                            <button type='submit' class='btn btn-primary waves-effect waves-light'>
                                                                <a href='recete_detay.php?Recete_no=$receteNo'>Detay</a></td></button>
                                                            <td>
                                                            
                                                                <a href='recete_sil.php?Recete_id=$receteID' onclick='location.reload();'>Sil</a>
                                                            </td>
