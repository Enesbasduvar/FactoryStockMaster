...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $miktar = $_POST['Miktar'];
    $iadeKaynagi = $_POST['Transfer_depo'];
    $barkod= $_POST['Barkod'];
    $mamulAdi=$_POST['UrunAdi'];
    


    // Ürün stokunu güncelle

    $sqlStokGuncelle = "UPDATE urunler SET Urun_Stok = Urun_Stok - $miktar WHERE Barkod = '$barkod'";
    ...
    $sqlIadeKaydet = "INSERT INTO mamul_transfer (UrunAdi, Miktar ,Transfer_depo) VALUES ((SELECT Urun_Adi FROM urunler WHERE Barkod = '$barkod'), $miktar, '$iadeKaynagi')";
...
<h2>Mamül Transfer</h2>
    <form method="post" action="">
    <div class="form-group">
                                        <label>Mamül Barkod</label>
                                        <input type="text" class="form-control"  name="Barkod" id="defaultconfig" />
                                    </div>

                                <div class="form-group">
                                    <label>Mamül Adı</label>
                                    <input type="text" class="form-control"  name="UrunAdi" id="defaultconfig" />
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Transfer Depo</label>
                                        <input type="text" class="form-control"  name="Transfer_depo" id="placement" />
                                    </div>
