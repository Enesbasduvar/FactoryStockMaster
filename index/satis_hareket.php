                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box d-flex align-items-center justify-content-between">
                                <h4 class="mb-0 font-size-18">Mamül stok hareketleri</h4>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <thead>
                                        ...
                                        $sqlHareketler = "SELECT stok_hareketleri.hareket_id, urunler.Urun_Adi, stok_hareketleri.hareket_tipi, 
                                        stok_hareketleri.hareket_Tarihi, stok_hareketleri.miktar, receteler.Recete_no
                                                        ...
                                                        ORDER BY stok_hareketleri.hareket_id DESC";

                                        $resultHareketler = $baglan->query($sqlHareketler);
                                        ?>
                                        ...
                                        <form method="POST" action="">
                                                    ...
                                                    <?php 
                                                    if(mysqli_num_rows($resultHareketler) > 0){
                                                        while($row = mysqli_fetch_assoc($resultHareketler)){
                                                            echo "<tr>";
                                                            echo "<td>" . $row["Urun_Adi"] . "</td>";
                                                            echo "<td>" . $row["hareket_tipi"] . "</td>";
                                                            echo "<td>" . $row["hareket_Tarihi"] . "</td>"; 
                                                            echo "<td>" . $row["miktar"] . "</td>";
                                                            echo "<td><a href='recete_detay.php?Recete_no=" . $row["Recete_no"] . "'>" . $row["Recete_no"] . "</a></td>";
                                                            echo "</tr>";
                                                        }
                                                    } else {
