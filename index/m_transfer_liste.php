                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <th>Tarih</th>
                                            ...
                                            $sqlIade = "SELECT * FROM mamul_transfer";
                                            $resultIade = $baglan->query($sqlIade);
        if ($resultIade->num_rows > 0) {
            while ($rowIade = $resultIade->fetch_assoc()) {
                echo "<tr>";
                
                echo "<td>" . $rowIade["UrunAdi"] . "</td>";
                echo "<td>" . $rowIade["Miktar"] . "</td>";
                echo "<td>" . $rowIade["Transfer_depo"] . "</td>";
                echo "<td>" . $rowIade["Tarih"] . "</td>";
