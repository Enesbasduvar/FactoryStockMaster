...
<!-- Left Sidebar End -->
            ...
            <div class="page-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <?php
                                            include("Baglan.php");
                echo "<h3>Yarı Mamüller</h3>";
                $sqlHammadde = "SELECT * FROM yarimamuller";
                ...
                if ($resultHammadde->num_rows > 0) {
                    ...
                    while ($row = $resultHammadde->fetch_assoc()) {
                       ...
                       <td><a href='Guncelle.php?id={$row['YM_id']}&tur=yarimamuller'>Güncelle</a></td>
                       <td><a href='?delete={$row['YM_id']}&tur=yarimamuller'>Sil</a></td>
                       </tr>";
                    }
                    echo "</table>";
                } else {
                       echo "Yarı mamül bulunamadı.";
                }?>
    ...
    if (isset($_GET['delete'])) {
        $deleteID = $_GET['delete'];
            ...
            deleteProduct($baglan, 'yarimamuller', 'YM_id', $deleteID);
