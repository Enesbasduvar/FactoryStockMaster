...
<body>
        ...
        <div class="main-content">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <?php
                                           include("Baglan.php");
           // hammadde sorgula ve listele
         echo "<h3>Ham Maddeler</h3>";
         ...
         if ($resultHammadde->num_rows > 0) {
             ...
             while ($row = $resultHammadde->fetch_assoc()) {
                echo "<tr>
                <td>" . $row['HM_Barkod'] . "</td>
                <td>" . $row['HM_serkeft_adi'] . "</td>
                <td>" . $row['HM_Stok'] . "</td>
                <td><a href='Guncelle.php?id={$row['HM_id']}&tur=ham_madde'>Güncelle</a></td>
                <td><a href='?delete={$row['HM_id']}&tur=ham_madde'>Sil</a></td>
                </tr>";
             }
             echo "</table>";
         } else {
                echo "Hammadde bulunamadı.";
         }?>
                                            </tbody>
                                        </table>
                                    </div>
    ...
    if (isset($_GET['delete'])) {
        $deleteID = $_GET['delete'];
            ...
            deleteProduct($baglan, 'ham_madde', 'HM_id', $deleteID);
