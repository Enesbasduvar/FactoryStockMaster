                                ...
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <th>Tarih</th>
                                            ...
                                            $sqlIade = "SELECT * FROM iade";
                                            $resultIade = $baglan->query($sqlIade);
        if ($resultIade->num_rows > 0) {
            while ($rowIade = $resultIade->fetch_assoc()) {
                echo "<tr>";
                
                echo "<td>" . $rowIade["Iade_HamMaddeAdi"] . "</td>";
                echo "<td>" . $rowIade["Iade_Miktar"] . "</td>";
                echo "<td>" . $rowIade["Iade_GeldigiYer"] . "</td>";
                echo "<td>" . $rowIade["Iade_Tarih"] . "</td>";
                
                echo "</tr>";
            }
        } else {
            echo "<tr><td colspan='4'>Iade bulunamadı.</td></tr>";
        }
        ?>
    </table>
